...
// Unity
using UnityEngine;
using static FsOptimizer.FsOptimizer;
...
namespace FsOptimizer
{
    ...
    public static class ConfigManager
    {
        ...
        public static void SaveConfig()
        {
            try
            {
                ...
                // === AntiGrief settings ===
                currentConfig.MaxActionsPerSecond = RateLimiter.GetCurrentMax();
                currentConfig.RateWindowSeconds = RateLimiter.GetCurrentWindow();

                // Respect logging and blocking toggles
                currentConfig.EnableFileLogging = currentConfig.EnableFileLogging;
                currentConfig.EnableSpawnBlocking = currentConfig.EnableSpawnBlocking;
            ...
            {
                MelonLogger.Error($"[FsOptimizer] Failed to save config: {e.Message}");
            }
        }
    ...
    public class FsOptimizer : MelonMod
    {
        ...
        public static class RateLimiter
        {
            ...
            {
                return _maxActionsPerSecond;
            }

            public static float GetCurrentWindow()
            {
                return _rateWindow;
            }
        ...
        public static class AntiGriefLogger
        {
            ...
            public static void Log(string message)
            {
                try
                {
                    // Only log if host, in server, and AntiGrief enabled
                    ...
                    MelonLogger.Msg($"[AntiGrief] {message}");
                }
                catch (Exception ex)
                {
